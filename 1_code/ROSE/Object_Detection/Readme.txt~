...
//SVM
1. Go into object_detection/bin
2. run ./find_object
3. drop the image of the item you want detected into the left side of the application (drop monster can provided)
4. Hit space bar to run the program
